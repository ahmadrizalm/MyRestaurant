...
<div style="width:100%; height:80px; overflow:hidden; margin: 0 auto; background-color:#333">
  ...
  <div style="width:750px; height:80px; margin: 0 auto; overflow:hidden; position:relative">
        ...
        <div id="caption" style="height:44px; margin-top:20px;float:left; margin-left:12px; position:absolute"> MyRestaurant </div>
...
<div style="width:750px; height:450px; overflow:hidden; margin: 0 auto; position:relative; margin-top:35px;">
	...
	<a href="PC"><div id="btn1" style="float:left"> <p> PC Manager </p> </div> </a>
    <a href="PC%20Kasir"><div id="btn2" style="float:left"> <p> PC Kasir </p> </div> </a>
    <a href="http://ub.ac.id/"><div id="btn3" style="float:left"> <p> UB Official </p> </div> </a>
    <a href="TouchScreen"><div id="btn4" style="float:left"> <p> LCD Chef </p> </div> </a>
    <a href="HP"><div id="btn5" style="float:left"> <p> HP Pelayan </p> </div> </a>
    <a href="http://filkom.ub.ac.id/" target="main"><div id="btn6" style="float:left"> <p> FILKOM UB </p> </div> </a>
...
<div style="width:100%; height:220px; overflow:hidden; margin: 0 auto; background-color:#333; margin-top:20px;">
    <div style="width:750px; height:80px; margin: 0 auto;">
        <p style="text-align:center; color:#FFF;"><b>by DreamTeam - 2015 </b></p>
        <p style="text-align:center; color:#FFF; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; font-size:x-small">Free Template by <a href="http://www.techgyo.com">TechGyo</a> tech blog &copy; 2013 All rights reserved. </p>
    </div>
</div>
