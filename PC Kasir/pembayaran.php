...
if($tampung==""){
    echo "<script> alert('Nomor Nota atau Nomor Meja tidak ada dalam database!'); location = 'page.php'; </script>";
}
        ...
        <div id="main">
            ...
            <div id="site_content">
                ...
                <div id="content">
                    ...
                    <hr><br><br>
                    Bayar sekarang?<br>
                    <form action="bayar_makan.php" method="post">
                    <table>
                    <tr>
                        <th>Nomor Nota</th>
                        <th><input type="number" name="nota" value="<?php echo $tmp['id_nota']; ?>" readonly></th>
                    </tr>
                    <tr>
                        <th>Nomor Meja</th>
                        <th><input type="number" name="meja" value="<?php echo $tmp['nomor_meja']; ?>" readonly></th>
                    </tr>
                    <tr>
                        <th>Tanggal Pesan</th>
                    ...
                    <tr>
                        ...
                        <th><?php echo $tmp['status_pemesanan']; ?></th>
                    </tr>
                    </table>
                    <table>
                    <tr>
                    ...
                    ?>
                        ...
                        <td><?php echo $record3['jumlah_harga']; ?></td>
                    </tr>
                    </table>
                        <div align="left">
                            <input style="width:60%" type="submit" name="bayar" value="Bayar Tagihan">
                        </div>
                    </form>
                </div>
            </div>
