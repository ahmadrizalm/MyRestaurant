            ...
            <div id="site_content">
                ...
                <div id="content">
                    ...
                    <table style="border-spacing:0">
                        <form action="proses_tambahkan.php" method="post">
                            <tr><td>NIP</td><td><input type=text name="nip"></td></tr>
                            <tr><td>Password</td><td><input type=password name="password"></td></tr>
                            <tr><td>Ulangi Password</td><td><input type=password name="password"></td></tr>
                            <tr><td>Nama Lengkap</td><td><input type=text name="nama"></td></tr>
                            <tr><td>Tempat Lahir</td><td><input type=text name="tmp_lahir"></td></tr>
                        ...
                        <input style="width:46%" type="submit" name="tambah" value="Tambahkan!">
                        </form>
                </div>
            </div>
