        ...
        <div id="main">
            ...
            <div id="site_content">
                ...
                <div id="content">
                    ...
                    <?php
                        include "koneksi.php";
                        $jumlah = mysql_query("SELECT SUM(total_harga) AS jumlah_harga FROM pesanan");
                        $temp = mysql_fetch_array($jumlah);
                        if(isset($_POST['tanggal'])){
                            $tglnya = $_POST['tanggal'];
                        ?>
                        <tr><th>Pendapatan pada</th><th><?php echo $tglnya; ?></th></tr>
                        <?php
                        }
                        else {
                            $bul = $_POST['bulan'];
                            $tah = $_POST['tahun'];
                        ?>
                            <tr><th>Pendapatan pada</th><th><?php echo "Bulan:".$bul." Tahun:".$tah; ?></th></tr>
                        <?php
                        }
                    ?>
                        <tr><td>Rp</td><td><?php echo $temp['jumlah_harga']; ?></td></tr>
                    </table>
                </div>
            </div>
