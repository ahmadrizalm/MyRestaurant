        ...
        <div id="main">
            ...
            <div id="site_content">
                ...
                <div id="content">
                    ...
                    <h3>Kelola User</h3>
                    <hr><br><br>
                    <a class="btn2" href="tambahkan_user.php">Tambahkan User</a>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $record['tmp_lahir']; ?></td>
                            <td><?php echo $record['tgl_lahir']; ?></td>
                            <td><?php echo $record['jabatan']; ?></td>
                            <td><a class="btn" href="ubah_user.php?nip=<?php echo $record['nip']; ?>">Ubah</a></td>
                            <td><a class="btn1" href="hapus_user.php?nip=<?php echo $record['nip']; ?>">Hapus</a></td>
                        </tr>
                    <?php
                        //Berhenti Looping 
                        }
