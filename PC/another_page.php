        ...
        <div id="main">
            <div id="header">
                ...
                <div id="menubar">
                    <ul id="menu">
                        ...
                        <li class="selected"><a href="another_page.php">Hasil Penjualan</a></li>
            ...
            <div id="site_content">
                ...
                <div id="content">
                    ...
                    <form action="tampilkan_hasil_penjualan.php" method="post">
                        <tr><td>Tanggal/Bulan/Tahun:</td><td><input type="date" name="tanggal"></td></tr>
                        <tr><td></td><td><input style="width:62%" type=submit name="penjualan" value="Hasil Penjualan"></td></tr>
                    </form>
                    </table>
                    <b>Bulanan : </b>
                    <table style="width:80%; border-spacing:0">
                    <form action="tampilkan_hasil_penjualan.php" method="post">
                        <tr><td style="width:40%">Bulan:</td><td><input type="number" name="bulan"></td></tr>
                        <tr><td style="width:40%">Tahun:</td><td><input type="number" name="tahun"></td></tr>
                        <tr><td></td><td><input style="width:60%" type=submit name="penjualan" value="Hasil Penjualan"></td></tr>
                    </form>
                    </table>
                    <b>Tahunan : </b>
                    <table style="width:80%; border-spacing:0">
