                ...
                <div id="content">
                    ...
                    <table style="border-spacing:0">
                        <form action="proses_edit.php" method="post">
                            ...
                            <tr><td>Password Baru</td><td><input type=password name="passwordku"></td></tr>
                            <tr><td>Ulangi Password Baru</td><td><input type=password name="passwordku2"></td></tr>
                            <tr><td>Nama Lengkap</td><td><input type=text name="nama" value="<?php echo $nama ?>"></td></tr>
                            <tr><td>Tempat Lahir</td><td><input type=text name="tmp_lahir" value="<?php echo $tmp_lahir ?>"></td></tr>
                        ...
                        <input style="width:51%" type="submit" name="ubah" value="Ubah Data!">
                        </form>
                </div>
            </div>
