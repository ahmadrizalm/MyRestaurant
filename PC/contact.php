        ...
        <div id="main">
            ...
            <div id="site_content">
                ...
                <div id="content">
                    ...
                    <hr><br><br>
                    <h4>Menu Favorit Pelanggan dalam bentuk Tabel</h4>
                    <a class="btn2" href="pola_konsumsi_tabel.php">Check</a><br><br>
                    <h4>Menu Favorit Pelanggan dalam bentuk Grafik</h4>
                    <a class="btn2" href="pola_konsumsi_grafik.php">Check</a>
                </div>
            </div>
