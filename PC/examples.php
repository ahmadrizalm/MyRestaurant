        ...
        <div id="main">
            ...
            <div id="site_content">
                ...
                <div id="content">
                    ...
                    <h3>Kelola Menu Makan dan Minum</h3>
                    <hr>
                    <br><br>
                    <a class="btn2" href="tambahkan_menu.php">Tambahkan Menu</a>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $record['harga_menu']; ?></td>
                            <td><a class="btn" href="ubah_menu.php?id_menu=<?php echo $record['id_menu']; ?>">Ubah</a></td>
                            <td><a class="btn1" href="hapus_menu.php?id_menu=<?php echo $record['id_menu']; ?>">Hapus</a></td>
                        </tr>
                    <?php
                        //Berhenti Looping 
                        }
