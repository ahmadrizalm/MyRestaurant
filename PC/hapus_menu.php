...
if(isset($_SESSION['user'])){
    ...
    include "koneksi.php";
	$id         = $_GET['id_menu'];
	$query      = mysql_fetch_array(mysql_query("select * from menu where id_menu='$id'"));
    $nama       = $query['nama_menu'];
    $harga      = $query['harga_menu'];
?>
<!DOCTYPE HTML>
<html>
        ...
        <div id="main">
            ...
            <div id="site_content">
                ...
                <div id="content">
                    ...
                    <h3>Hapus Menu Makan dan Minum</h3>
                    <hr><br><br>
                    <font color="red"><b>Anda yakin menghapus menu ini dari database?</b></font><br>
                    <table style="border-spacing:0">
                        <form action="proses_hapus_menu.php" method="post">
                            ...
                            <tr><td>Nama Menu</td><td><input type=text name="nama" value="<?php echo $nama; ?>" readonly></td></tr>
                            <tr><td>Harga</td><td><input type=text name="harga" value="<?php echo $harga; ?>" readonly></td></tr>
                    </table>
                        <input style="width:42%" type="submit" name="hapus" value="Hapus Menu!">
                        </form>
                </div>
            </div>
